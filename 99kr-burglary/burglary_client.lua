...
local PlayerData              = {}
TriggerEvent('esx:tapatiocockandballs', function(obj) 
  ESX = obj
...
local burglaryInside = {
    ["Jewels"] = { x = 342.23, y = -1003.29, z = -99.0, item = 'jewels', amount = math.random(1,3)},
    ["Jewels1"]  = {x = 338.14, y = -997.69, z = -99.2, item = 'jewels', amount = math.random(1,3)},
    ["Jewels2"] = { x = 350.91 , y = -999.26 , z = -99.2, item = 'jewels', amount = math.random(1,3)},
    ["Jewels3"] = { x = 349.19, y = -994.83, z = -99.2, item = 'jewels', amount = math.random(1,3)},
    ["Jewels4"]  = { x = 345.3, y = -995.76, z = -99.2, item = 'jewels', amount = math.random(1,3)},
    ["Jewels5"] = { x = 346.14, y = -1001.55, z = -99.2, item = 'jewels', amount = math.random(1,3)},
    ["Jewels6"] = { x = 347.23, y = -994.09, z = -99.2, item = 'jewels', amount = math.random(1,3)},
    ["Jewels7"] = { x = 339.23, y = -1003.35, z = -99.2, item = 'jewels', amount = math.random(1,3)}
}
