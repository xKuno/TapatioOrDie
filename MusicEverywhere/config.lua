...
Config.DistanceToVolume = 7.0 -- The distance that will be with the volume at 1.0, so if the volume is 0.5 the distance will be 15.0, if the volume is 0.2 the distance will be 6.
...
Config.Zones = {
	{
		...
		range = 5.0, -- the range that music can be heard
