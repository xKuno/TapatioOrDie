...
AddEventHandler("esx_inventoryhud:openPlayerInventory", function(target, playerName)
    PlayerData = ESX.GetPlayerData()
            ...
            TriggerServerEvent("esx_inventoryhud:open1", "[" ..targetPlayerName .."]",true);
...
--[[RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
            ...
            TriggerServerEvent("esx_inventoryhud:sdad90209490244", GetPlayerServerId(PlayerId()), targetPlayer, data.item.type, data.item.name, count)
        end
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
            ...
            TriggerServerEvent("esx_inventoryhud:sdad90209490244", targetPlayer, GetPlayerServerId(PlayerId()), data.item.type, data.item.name, count)
        end
