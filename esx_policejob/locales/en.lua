Locales['en'] = {
  ...
  ['pharmacy_take1'] = 'Bullet-Proof Vest',
  ['pharmacy_take2'] = 'Weapon Clip',
  ['put_weapon'] = 'store weapon in armory',
  ['buy_weapons'] = 'buy weapons',
  ['armory'] = 'armory',
  ['max_item'] = 'You already have the max limit for this item',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the ~y~Armory~s~.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ['pharmacy_menu_title'] = 'Buy Armory',
  ...
  ['jail_menu'] = 'Send To Jail',
  ['jail_menu_info'] = 'Set Time',
  -- Vehicle interaction
