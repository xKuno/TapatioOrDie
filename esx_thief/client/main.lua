...
AddEventHandler('esx:setJob', function(job)
  ...
  print("job set to " .. job)
		...
		while true do
			Citizen.Wait(20)
			--if PlayerData.job and ( PlayerData.job.name == "unemployed" or PlayerData.job.name == "unemployed" then -- comment this line if you want to allow all player to loot
    ...
    ESX.TriggerServerCallback('if_dead:getOtherPlayerData', function(data)
      if data.job == "police" then
        ESX.ShowHelpNotification("~r~You can't rob this person!", false, false, 3000)
