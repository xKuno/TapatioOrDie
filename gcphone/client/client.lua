...
RegisterNetEvent("ImgUploaded")
AddEventHandler("ImgUploaded", function(link, callbackID)
  print(link, callbackID)
  print(imgCallbacks[tostring(callbackID)])
  imgCallbacks[tostring(callbackID)](link)
end)
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  while takePhoto do
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      local id = math.random(1, 1000000) * 100
      TriggerServerEvent("TakePhoto", id)
      imgCallbacks[tostring(id)] = function(resp)
        DestroyMobilePhone()
        CellCamActivate(false, false)
