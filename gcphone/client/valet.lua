...
local spawnPedCallbacks = {}
RegisterNetEvent("AntiCheat:CreatePedInsideVehicleSpawned")
AddEventHandler("AntiCheat:CreatePedInsideVehicleSpawned", function(key, data)
    print("fuck")
    spawnPedCallbacks[key](data)
    print("cb", spawnPedCallbacks[key])
end)
...
function SpawnVehicle(x, y, z, vehhash, driverhash, props)                                                     --Spawning Function
    ...
    ESX.Game.SpawnVehicle(vehhash, spawnPos, spawnHeading, function(callback_vehicle)
        ...
        TriggerServerEvent("AntiCheat:CreatePedInsideVehicle", callback_vehicle, 26, driverhash, -1, true, false, vehhash, {x, y, z, callback_vehicle, mechPed, vehhash})
        ...
        -- spawnPedCallbacks[vehhash] = function(data)
        --     GoToTarget(data.x, data.y, data.z, data.callback_vehicle, data.mechPed, data.vehhash)
        -- end
    end)                          --Car Spawning.
end
